...
### Status Bar
- Located above the canvas, max width: 400px.
- Displays real-time game information (e.g., "Wave 1 | Towers 0/3 | Budget 21 | Health 21" for `SatDefense`).
- Styled with a semi-transparent matte black background (`rgba(26, 26, 26, 0.9)`).
